# 1- [API NodeJS + Express + Mongo] Estrutura e cadastro | Diego Fernandes
...
# 3- [API NodeJS + Express + Mongo] Recuperação de senha com NodeMailer | Diego Fernandes

- https://youtu.be/Zwdv9RllPqU
